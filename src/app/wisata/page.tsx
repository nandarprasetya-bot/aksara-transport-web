...
const oneDayPackages = [
    ...
    { id: 'Paket F', name: 'Paket F: Rock Coastline & Wonderland', badge: 'Gunungkidul Ocean', badgeColor: '#e0f2fe', badgeText: '#0369a1', image: '/images/tour_rock_coastline.png', desc: 'Petualangan menyusuri jajaran destinasi pesisir pantai Gunungkidul yang berkarang megah dan modern.', destinations: 'On The Rock, Gesing Wonderland, Puncak Segoro, Obelix Sea View.' },
    { id: 'Paket G', name: 'Paket G: Bali van Jogja & Ocean Cliffs', badge: 'Pura & Pantai', badgeColor: '#e0f2fe', badgeText: '#0369a1', image: '/images/tour_ngobaran_bali.png', desc: 'Menikmati sensasi pura eksotis di bibir tebing laut layaknya Bali, berpadu keindahan pantai selatan.', destinations: 'Pantai Ngobaran, Gesing Wonderland, Puncak Segoro, Obelix Sea View.' },
    { id: 'Paket H', name: 'Paket H: White Sands & Sea View Sunset', badge: 'Pantai Pasir Putih', badgeColor: '#e0f2fe', badgeText: '#0369a1', image: '/images/tour_white_sands.png', desc: 'Petualangan menyusuri pantai pasir putih Gunungkidul yang berair jernih, dilanjut bersantai di atas tebing.', destinations: 'On The Rock, Pantai Sadranan, Pantai Slili, Obelix Sea View.' },
    { id: 'Paket I', name: 'Paket I: Timang Gondola & Cave Tubing', badge: 'Petualangan Ekstrim', badgeColor: '#ffedd5', badgeText: '#ea580c', image: '/images/tour_timang_gondola.png', desc: 'Uji nyali menaiki kereta gantung kayu tradisional ke pulau karang laut, digabung serunya susur goa basah.', destinations: 'Pantai Timang, Goa Pindul, Pictniq Land.' },
    { id: 'Paket J', name: 'Paket J: Menoreh, VW Heritage & Bukit Rhema', badge: 'Borobudur & Menoreh', badgeBg: 'success', image: '/images/tour_menoreh_vw.png', desc: 'Melihat lanskap pegunungan Menoreh yang menawan, dilanjut keliling desa Borobudur naik VW klasik.', destinations: 'Tumpeng Menoreh, Vw Safari Tour, Candi Borobudur, Gereja Ayam.' },
    { id: 'Paket K', name: 'Paket K: Pine Valley, Cave Tubing & Cliffs', badge: 'Mangunan & Goa', badgeBg: 'success', image: '/images/tour_cave_tubing.png', desc: 'Merasakan embun pagi bukit buah, ketenangan jajaran pohon pinus tinggi, hingga petualangan sungai bawah tanah.', destinations: 'Kebun Buah, Hutan Pinus, Goa Pindul, Pictniq Land.' },
    { id: 'Paket Dieng', name: 'Paket Dieng: Sikunir Sunrise & Vulkanik', badge: 'Negeri Di Atas Awan', badgeColor: '#ffedd5', badgeText: '#ea580c', image: '/images/tour_dieng_sunrise.png', desc: 'Mengunjungi dataran tinggi Dieng yang berselimut kabut, melihat kawah aktif, dan menikmati golden sunrise tercantik.', destinations: 'Puncak Sikunir, Kawah Sikidang, Candi Arjuna, Gardu Pandang Tieng.', isDieng: true }
];
