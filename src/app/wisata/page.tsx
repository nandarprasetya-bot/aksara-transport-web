...
const oneDayPackages = [
    ...
    { id: 'Paket C', name: 'Paket C: Volcano, Sand Dunes & Sea View', badge: 'Petualangan & Sunset', badgeColor: '#ffedd5', badgeText: '#ea580c', image: '/images/tour_merapi.webp', desc: 'Petualangan lengkap dari dinginnya lereng Gunung Merapi hingga keindahan sunset tebing laut pantai selatan.', destinations: 'Lavatour Merapi, Kopi Klothok, Gumukpasir, Obelix Sea View.' },
    { id: 'Paket D', name: 'Paket D: Prambanan, Pines & Ocean Sunset', badge: 'Kombinasi Alam', badgeColor: '#fce7f3', badgeText: '#db2777', image: '/images/tour_parangtritis.webp', desc: 'Menyusuri mahakarya candi Hindu kuno, kesejukan hutan pinus, hingga pasir putih dan tebing samudera.', destinations: 'Candi Prambanan, Hutan Pinus, Gumukpasir, Obelix Sea View.' },
    ...
    { id: 'Paket F', name: 'Paket F: Rock Coastline & Wonderland', badge: 'Gunungkidul Ocean', badgeColor: '#e0f2fe', badgeText: '#0369a1', image: '/images/tour_parangtritis.webp', desc: 'Petualangan menyusuri jajaran destinasi pesisir pantai Gunungkidul yang berkarang megah dan modern.', destinations: 'On The Rock, Gesing Wonderland, Puncak Segoro, Obelix Sea View.' },
    { id: 'Paket G', name: 'Paket G: Bali van Jogja & Ocean Cliffs', badge: 'Pura & Pantai', badgeColor: '#e0f2fe', badgeText: '#0369a1', image: '/images/tour_parangtritis.webp', desc: 'Menikmati sensasi pura eksotis di bibir tebing laut layaknya Bali, berpadu keindahan pantai selatan.', destinations: 'Pantai Ngobaran, Gesing Wonderland, Puncak Segoro, Obelix Sea View.' },
    { id: 'Paket H', name: 'Paket H: White Sands & Sea View Sunset', badge: 'Pantai Pasir Putih', badgeColor: '#e0f2fe', badgeText: '#0369a1', image: '/images/tour_parangtritis.webp', desc: 'Petualangan menyusuri pantai pasir putih Gunungkidul yang berair jernih, dilanjut bersantai di atas tebing.', destinations: 'On The Rock, Pantai Sadranan, Pantai Slili, Obelix Sea View.' },
    { id: 'Paket I', name: 'Paket I: Timang Gondola & Cave Tubing', badge: 'Petualangan Ekstrim', badgeColor: '#ffedd5', badgeText: '#ea580c', image: '/images/tour_kulonprogo.webp', desc: 'Uji nyali menaiki kereta gantung kayu tradisional ke pulau karang laut, digabung serunya susur goa basah.', destinations: 'Pantai Timang, Goa Pindul, Pictniq Land.' },
    { id: 'Paket J', name: 'Paket J: Menoreh, VW Heritage & Bukit Rhema', badge: 'Borobudur & Menoreh', badgeBg: 'success', image: '/images/tour_kulonprogo.webp', desc: 'Melihat lanskap pegunungan Menoreh yang menawan, dilanjut keliling desa Borobudur naik VW klasik.', destinations: 'Tumpeng Menoreh, Vw Safari Tour, Candi Borobudur, Gereja Ayam.' },
    { id: 'Paket K', name: 'Paket K: Pine Valley, Cave Tubing & Cliffs', badge: 'Mangunan & Goa', badgeBg: 'success', image: '/images/tour_kulonprogo.webp', desc: 'Merasakan embun pagi bukit buah, ketenangan jajaran pohon pinus tinggi, hingga petualangan sungai bawah tanah.', destinations: 'Kebun Buah, Hutan Pinus, Goa Pindul, Pictniq Land.' },
    { id: 'Paket Dieng', name: 'Paket Dieng: Sikunir Sunrise & Vulkanik', badge: 'Negeri Di Atas Awan', badgeColor: '#ffedd5', badgeText: '#ea580c', image: '/images/tour_borobudur.webp', desc: 'Mengunjungi dataran tinggi Dieng yang berselimut kabut, melihat kawah aktif, dan menikmati golden sunrise tercantik.', destinations: 'Puncak Sikunir, Kawah Sikidang, Candi Arjuna, Gardu Pandang Tieng.', isDieng: true }
];
                            ...
                            <div className="wisata-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(280px, 1fr))', gap: '24px' }}>
                                {[2, 3, 4, 5, 6, 7].map(d => (
                                    <div key={d} className="special-package-card" style={{ background: 'linear-gradient(135deg, #ffffff 0%, #f8fafc 100%)', border: '1.5px solid var(--border-color)', borderRadius: 'var(--border-radius-md)', padding: '30px', textAlign: 'center', position: 'relative', overflow: 'hidden' }}>
                                        ...
                                        <img src={d % 2 === 0 ? '/images/tour_borobudur.webp' : '/images/tour_merapi.webp'} alt={`${d} Day Service`} style={{ width: '100%', height: '180px', objectFit: 'cover', borderRadius: 'var(--border-radius-sm)', marginBottom: '16px' }} />
